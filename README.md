# Flow Log Parser - Illumio Challenge

Hey there! Thanks for checking out my flow log parsing script. This script helps analyze AWS VPC flow logs and maps them with protocol numbers and custom lookup tables. It generates an output file containing Tag Counts and Port/Protocol Combination Counts. I'm open to any changes, improvements, or suggestions you might have! I’d love to hear your thoughts and ways I can make it better. Hit me up with any feedback you have.
